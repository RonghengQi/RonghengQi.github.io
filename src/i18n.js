...
export const zh = {
  ...
  education: [
    {
      org: "伦敦大学学院",
      desc: "风险与减灾研究型硕士",
      grade: "成绩：70.70/100（优等）",
      role: "英国伦敦",
      date: "2025年9月—2026年9月",
    },
    {
      org: "中国地质大学（武汉）",
      desc: "应急管理专业管理学学士",
  ...
  experience: [
    ...
    },
    {
      ...
      role: "国家级大学生创新训练项目 · 指导教师：阮班晓教授、李世祥教授 · 中国地质大学（武汉）",
      date: "2023年5月—2025年1月",
    },
    {
      org: "疫情后复工复产政策分析",
      desc: "对中国7个主要城市超过10万字的经济、交通和公共卫生政策文件进行结构化整理与分类。",
      role: "研究助理 · 导师：赵鹏军教授、刘启旸教授 · 北京大学深圳研究生院",
  ...
  awards: [
    ...
    { org: "国家级大学生创新训练计划优秀结题", date: "2025年" },
