...
export const site = {
  ...
  url: "https://ronghengqi.github.io",
  ...
  description:
    "Rongheng Qi is an MRes student in Risk and Disaster Reduction at " +
    "University College London, working on GeoAI, remote sensing, urban " +
    "flood risk and emergency response.",

  // Shorter line for link previews (WeChat, X, LinkedIn, Slack).
  socialDescription:
    "MRes student at UCL. GeoAI, remote sensing, urban flood risk and " +
    "emergency response.",
  ...
  // from src/data.js.
  seo: {
    jobTitle: "MRes Student in Risk and Disaster Reduction",
